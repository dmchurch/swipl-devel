...
if(HAVE_LIBUNWIND_H)
  check_library_exists(unwind unw_getcontext "" HAVE_LIBUNWIND_LIB)
endif()
if(HAVE_LIBUNWIND_H AND HAVE_LIBUNWIND_LIB)
  set(HAVE_LIBUNWIND 1 CACHE INTERNAL "Have -lunwind and libunwind.h")
else()
  set(HAVE_LIBUNWIND "" CACHE INTERNAL "Have -lunwind and libunwind.h")
endif()
